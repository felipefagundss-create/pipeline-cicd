...
Projeto de estudo pessoal sobre Cultura DevOps e Integração Contínua. A API em si é bem simples, só existe pra ter algo real rodando — o que importa mesmo é o pipeline: toda vez que dou push, ele builda, testa e deploya sozinho.
